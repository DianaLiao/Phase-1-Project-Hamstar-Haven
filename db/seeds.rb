...
caffein = Activity.create(name: "Cut out caffeine", description: "Too much caffeine actually cause fatigue in some people. Gradually cut back on coffee, tea, soft drinks and any medications contain caffeine. Stopping suddenly can cause caffeine withdrawal and more fatigue.")
...
expert = Activity.create(name: "Consult with a Mental Health Counselor", description: "If you feel tired and 'down' for more than a few weeks, please seek an advice of your primary care phisician.")
...
yoga = Activity.create(name: "Take a yoga class", description: "Yoga is a mind-body practice that combines physical poses, controlled breathing, and meditation or relaxation. Yoga may help reduce stress, lower blood pressure and lower your heart rate.")
...
solution9 = Solution.create(problem_id: problem2.id, activity_id: cafein.id)
